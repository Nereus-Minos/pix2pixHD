...
from pix2pixhd_model import pix2pixHD
...
def parse_arguments(argv):
    ...
    parser.add_argument('--old_lr', type=float, help='Initial learning rate', default=0.0002)
    ...
    parser.add_argument('--save_path', type=str, help='Model save paths', default="./save_model")
